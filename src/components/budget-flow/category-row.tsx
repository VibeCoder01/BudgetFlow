      ...
      <CardHeader className="p-4 pb-2">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center space-x-1 flex-shrink-0">
            ...
            <Button variant="ghost" size="icon" onClick={() => onDeleteCategory(category.id)} aria-label={`Delete ${localName}`} className="h-12 w-12 text-destructive hover:text-destructive/80 [&_svg]:size-8">
              <Trash2 />
            </Button>
          </div>
        </div>
